...
declare -ga _orb_available_arg_options=( Required: Default: In: Catch: Multiple: DefaultHelp: DefaultPresence: )
...
declare -ga _orb_available_arg_options_number_arg=( Required: Default: DefaultHelp: DefaultPresence: In: )
declare -ga _orb_available_arg_options_boolean_flag=( Required: Default: DefaultHelp: DefaultPresence: )
declare -ga _orb_available_arg_options_flag_arg=( Required: Default: DefaultHelp: DefaultPresence: Multiple: In: )
# flag args with suffix > 1 
declare -ga _orb_available_arg_options_array_flag_arg=( Required: Default: DefaultHelp: DefaultPresence: Multiple: )
declare -ga _orb_available_arg_options_block=( Required: Default: DefaultHelp: DefaultPresence: Multiple: )
declare -ga _orb_available_arg_options_dash=( Required: Default: DefaultHelp: DefaultPresence: )
declare -ga _orb_available_arg_options_rest=( Required: Default: DefaultHelp: DefaultPresence: Catch: )
