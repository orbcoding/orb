...
Describe '_orb_declared_is_boolean_flag'
  ...
  It 'fails for flagged arg with suffix'
    When call _orb_declared_is_boolean_flag 0
    The status should be failure
  End

  It 'fails for non flag args'
    When call _orb_declared_is_boolean_flag 2
    The status should be failure
  End
End
...
Describe '_orb_declared_is_array'
  ...
  It 'suceeds for flagged arg with suffix > 1'
    When call _orb_declared_is_array 0
    The status should be success
  End
  ...
  It 'suceeds for ...'
    When call _orb_declared_is_array 2
    The status should be success
  End

  It 'suceeds for block'
    When call _orb_declared_is_array 3
    The status should be success
  End

  It 'suceeds for --'
    When call _orb_declared_is_array 4
    The status should be success
  End
