...
Describe '_orb_get_current_sourcer_file_path'
  ...
  It 'gets path of sourcer file'
    When run source spec/fixtures/proxy.sh source $spec_orb/orb/bin/orb _orb_get_current_sourcer_file_path
    The output should equal spec/fixtures/proxy.sh
  End
End
...
Describe '_orb_get_current_function_from_source_chain'
  ...
  It 'gets function from source chain'
    ...
    When run source spec/fixtures/proxy.sh source spec/fixtures/proxy.sh source $spec_orb/orb/bin/orb _orb_get_current_function_from_source_chain
