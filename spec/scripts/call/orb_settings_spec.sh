...
Describe 'orb_settings.sh'
  ...
  It 'collects --help'
    When call source scripts/call/orb_settings.sh --help
    The variable "_orb_setting_help" should equal true
    The status should equal 1
  End

  It 'collects --d'
    When call source scripts/call/orb_settings.sh -d
    The variable "_orb_setting_direct_call" should equal true
    The status should equal 1
  End
  
  It 'collects -r'
    When call source scripts/call/orb_settings.sh -r
    The variable "_orb_setting_reload_functions" should equal true
    The status should equal 1
  End

  It 'collects -e'
    When call source scripts/call/orb_settings.sh -e spec_ext -e spec_ext2
  ...
  It 'returns number of steps to shift'
    When call source scripts/call/orb_settings.sh -e spec_ext -e spec_ext2 -r --help
